...
RELEASEDIR=ValheimMeshReplacerTemplate/bin/Release/net48
DLL=$RELEASEDIR/ValheimMeshReplacerTemplate.dll
BUN=../chebs-necromancy/ChebsNecromancyUnity/Assets/AssetBundles/enclavesix
PLUGINS=ValheimMeshReplacerTemplate/Package/plugins
README=README.md
...
ZIPDESTINATION="../bin/Release/net48/ValheimMeshReplacerTemplate.$VERSION.zip"
